...
/*
 It was previously initialized to 1, but we had to change it to 2 to
 avoid POST requests that were cached in Safari on iOS before this change.
 See bug #39134 for details.
 */
JSONRpcClient.requestId = 2;
